...
import { Github, Linkedin, Mail, ExternalLink, Instagram, Sparkles, Gitlab } from "lucide-react"
...
const SOCIAL_LINKS = [
  ...
  { icon: Linkedin, link: "https://www.linkedin.com/in/tan-sophary-750774320/" }
];
...
const Home = () => {
  ...
  const lottieOptions = {
    src: "https://lottie.host/5ab7aec1-a980-49d0-b773-47d7dfbe22c7/lHQmtdqxch.lottie",
    loop: true,
    autoplay: true,
    rendererSettings: {
      ...
      <div className={`relative z-10 transition-all duration-1000 ${isLoaded ? "opacity-100" : "opacity-0"}`}>
        <div className="container mx-auto px-[5%] sm:px-6 lg:px-[0%] min-h-screen">
          <div className="flex flex-col lg:flex-row items-center justify-center h-screen md:justify-between gap-0 sm:gap-12 lg:gap-20">
            ...
            <div className="w-full py-[15%] sm:py-0 lg:w-1/2 h-auto lg:h-[300px] xl:h-[450px] relative flex items-center justify-center order-2 lg:order-2 mt-8 lg:mt-0"
